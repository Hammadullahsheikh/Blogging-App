...
const Navbar = () => {
  ...
  return (
    <nav className="border-gray-200 dark:bg-gray-900 bg-[#fd9800] mt-3 p-4">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">

{/* logo start */}

        <Link to="/">
          <span className="self-center text-4xl hover:text-black whitespace-nowrap dark:text-white text-white font-bold">
            Drop Box
          </span>
        </Link>
...
{/* hamburger start */}
        ...
        <label className="btn-circle bg-[#fd9800] swap swap-rotate md:hidden">
